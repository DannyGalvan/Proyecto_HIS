...
{
    /// <summary>
    /// Defines the <see cref="UpdateLabOrderValidation" />
    /// </summary>
    public class UpdateLabOrderValidation : UpdateValidator<LabOrderRequest, long?>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLabOrderValidation"/> class.
        /// </summary>
        public UpdateLabOrderValidation()
        {
