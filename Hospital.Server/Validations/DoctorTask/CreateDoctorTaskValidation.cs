...
{
    /// <summary>
    /// Defines the <see cref="CreateDoctorTaskValidation" />
    /// </summary>
    public class CreateDoctorTaskValidation : CreateValidator<DoctorTaskRequest, long?>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDoctorTaskValidation"/> class.
        /// </summary>
        public CreateDoctorTaskValidation()
        {
