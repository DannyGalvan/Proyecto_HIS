...
{
    /// <summary>
    /// Defines the <see cref="UpdateLabExamValidation" />
    /// </summary>
    public class UpdateLabExamValidation : UpdateValidator<LabExamRequest, long?>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLabExamValidation"/> class.
        /// </summary>
        public UpdateLabExamValidation()
        {
            RuleFor(x => x.Name)
