...
{
    /// <summary>
    /// Defines the <see cref="CreateTimezoneValidation" />
    /// </summary>
    public class CreateTimezoneValidation : CreateValidator<TimezoneRequest, long?>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTimezoneValidation"/> class.
        /// </summary>
        public CreateTimezoneValidation()
        {
            RuleFor(x => x.IanaId)
