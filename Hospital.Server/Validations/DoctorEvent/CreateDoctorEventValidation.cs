...
{
    /// <summary>
    /// Defines the <see cref="CreateDoctorEventValidation" />
    /// </summary>
    public class CreateDoctorEventValidation : CreateValidator<DoctorEventRequest, long?>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDoctorEventValidation"/> class.
        /// </summary>
        public CreateDoctorEventValidation()
        {
