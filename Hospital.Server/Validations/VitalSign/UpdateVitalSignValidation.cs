...
{
    /// <summary>
    /// Defines the <see cref="UpdateVitalSignValidation" />
    /// </summary>
    public class UpdateVitalSignValidation : UpdateValidator<VitalSignRequest, long?>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateVitalSignValidation"/> class.
        /// </summary>
        public UpdateVitalSignValidation()
        {
