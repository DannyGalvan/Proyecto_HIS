...
} from "../types/MedicalConsultationResponse";
...
export const getMedicalConsultations = async ({
  ...
  return api.get<unknown, ApiResponse<MedicalConsultationResponse[]>>(
    baseQuery,
  );
};
...
export const getMedicalConsultationById = async (
  id: number,
): Promise<ApiResponse<MedicalConsultationResponse>> =>
  api.get<unknown, ApiResponse<MedicalConsultationResponse>>(
    `MedicalConsultation/${id}?include=Doctor`,
  );

export const createMedicalConsultation = async (
  data: MedicalConsultationRequest,
): Promise<ApiResponse<MedicalConsultationResponse>> =>
  api.post<
    unknown,
    ApiResponse<MedicalConsultationResponse>,
    MedicalConsultationRequest
  >("MedicalConsultation", data);
...
export const partialUpdateMedicalConsultation = async (
  data: MedicalConsultationRequest,
): Promise<ApiResponse<MedicalConsultationResponse>> =>
  api.patch<
    unknown,
...
export const deleteMedicalConsultation = async (
  ...
  api.delete<unknown, ApiResponse<MedicalConsultationResponse>>(
