...
} from "../types/InventoryMovementResponse";
...
export const getInventoryMovement = async (
  ...
  api.get<unknown, ApiResponse<InventoryMovementResponse>>(
    `InventoryMovement/${id}?Include=MedicineInventory,Medicine,Branch,User`,
  );
...
export const partialUpdateInventoryMovement = async (
  data: InventoryMovementRequest,
): Promise<ApiResponse<InventoryMovementResponse>> =>
  api.patch<
    unknown,
...
export const deleteInventoryMovement = async (
  ...
  api.delete<unknown, ApiResponse<InventoryMovementResponse>>(
