...
export const createSpecialty = async (
  ...
  api.post<unknown, ApiResponse<SpecialtyResponse>, SpecialtyRequest>(
    "Specialty",
    data,
  );
...
export const updateSpecialty = async (
  ...
  api.put<unknown, ApiResponse<SpecialtyResponse>, SpecialtyRequest>(
    "Specialty",
    data,
  );
