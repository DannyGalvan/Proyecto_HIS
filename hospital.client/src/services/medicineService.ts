...
import type {
  MedicineInventoryRequest,
  MedicineInventoryResponse,
} from "../types/MedicineInventoryResponse";
import type {
  MedicineRequest,
  MedicineResponse,
} from "../types/MedicineResponse";
...
export const getMedicineById = async (
  id: number,
): Promise<ApiResponse<MedicineResponse>> =>
  api.get<unknown, ApiResponse<MedicineResponse>>(`Medicine/${id}`);

export const createMedicine = async (
  data: MedicineRequest,
): Promise<ApiResponse<MedicineResponse>> =>
  api.post<unknown, ApiResponse<MedicineResponse>, MedicineRequest>(
    "Medicine",
    data,
  );
...
export const updateMedicine = async (
  ...
  api.put<unknown, ApiResponse<MedicineResponse>, MedicineRequest>(
    "Medicine",
    data,
  );
...
export const getMedicineInventoryById = async (
  id: number,
): Promise<ApiResponse<MedicineInventoryResponse>> =>
  api.get<unknown, ApiResponse<MedicineInventoryResponse>>(
    `MedicineInventory/${id}?Include=Medicine,Branch`,
  );

export const createMedicineInventory = async (
  data: MedicineInventoryRequest,
): Promise<ApiResponse<MedicineInventoryResponse>> =>
  api.post<
    unknown,
    ApiResponse<MedicineInventoryResponse>,
    MedicineInventoryRequest
...
export const partialUpdateMedicineInventory = async (
  data: MedicineInventoryRequest,
): Promise<ApiResponse<MedicineInventoryResponse>> =>
  api.patch<
    unknown,
