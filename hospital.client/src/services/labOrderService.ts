...
} from "../types/LabOrderItemResponse";
import type {
  LabOrderRequest,
  LabOrderResponse,
} from "../types/LabOrderResponse";
...
export const getLabOrderById = async (
  id: number,
): Promise<ApiResponse<LabOrderResponse>> =>
  api.get<unknown, ApiResponse<LabOrderResponse>>(
    `LabOrder/${id}?Include=Consultation,Doctor,Patient,Items`,
  );

export const createLabOrder = async (
  data: LabOrderRequest,
): Promise<ApiResponse<LabOrderResponse>> =>
  api.post<unknown, ApiResponse<LabOrderResponse>, LabOrderRequest>(
    "LabOrder",
    data,
  );
...
export const updateLabOrder = async (
  ...
  api.put<unknown, ApiResponse<LabOrderResponse>, LabOrderRequest>(
    "LabOrder",
    data,
  );

export const partialUpdateLabOrder = async (
  data: LabOrderRequest,
): Promise<ApiResponse<LabOrderResponse>> =>
  api.patch<unknown, ApiResponse<LabOrderResponse>, LabOrderRequest>(
    "LabOrder",
    data,
  );
...
export const partialUpdateLabOrderItem = async (
  data: LabOrderItemRequest,
): Promise<ApiResponse<LabOrderItemResponse>> =>
  api.patch<unknown, ApiResponse<LabOrderItemResponse>, LabOrderItemRequest>(
    "LabOrderItem",
    data,
  );

export const createLabOrderItem = async (
  data: LabOrderItemRequest,
): Promise<ApiResponse<LabOrderItemResponse>> =>
  api.post<unknown, ApiResponse<LabOrderItemResponse>, LabOrderItemRequest>(
    "LabOrderItem",
    data,
  );

export const deleteLabOrderItem = async (
  id: number,
): Promise<ApiResponse<LabOrderItemResponse>> =>
