...
export const getLaboratoryById = async (
  id: number,
): Promise<ApiResponse<LaboratoryResponse>> =>
  api.get<unknown, ApiResponse<LaboratoryResponse>>(`Laboratory/${id}`);

export const createLaboratory = async (
  data: LaboratoryRequest,
): Promise<ApiResponse<LaboratoryResponse>> =>
  api.post<unknown, ApiResponse<LaboratoryResponse>, LaboratoryRequest>(
    "Laboratory",
    data,
  );
...
export const updateLaboratory = async (
  ...
  api.put<unknown, ApiResponse<LaboratoryResponse>, LaboratoryRequest>(
    "Laboratory",
    data,
  );
