...
export const getDoctorEvent = async (
  id: number,
): Promise<ApiResponse<DoctorEventResponse>> =>
  api.get<unknown, ApiResponse<DoctorEventResponse>>(
    `DoctorEvent/${id}?Include=Doctor`,
  );

export const createDoctorEvent = async (
  data: DoctorEventRequest,
): Promise<ApiResponse<DoctorEventResponse>> =>
  api.post<unknown, ApiResponse<DoctorEventResponse>, DoctorEventRequest>(
    "DoctorEvent",
    data,
  );

export const updateDoctorEvent = async (
  data: DoctorEventRequest,
): Promise<ApiResponse<DoctorEventResponse>> =>
  api.put<unknown, ApiResponse<DoctorEventResponse>, DoctorEventRequest>(
    "DoctorEvent",
    data,
  );

export const patchDoctorEvent = async (
  data: DoctorEventRequest,
): Promise<ApiResponse<DoctorEventResponse>> =>
  api.patch<unknown, ApiResponse<DoctorEventResponse>, DoctorEventRequest>(
    "DoctorEvent",
    data,
  );

export const deleteDoctorEvent = async (
  id: number,
): Promise<ApiResponse<DoctorEventResponse>> =>
