...
export const getDoctorTask = async (
  id: number,
): Promise<ApiResponse<DoctorTaskResponse>> =>
  api.get<unknown, ApiResponse<DoctorTaskResponse>>(
    `DoctorTask/${id}?Include=Doctor`,
  );

export const createDoctorTask = async (
  data: DoctorTaskRequest,
): Promise<ApiResponse<DoctorTaskResponse>> =>
  api.post<unknown, ApiResponse<DoctorTaskResponse>, DoctorTaskRequest>(
    "DoctorTask",
    data,
  );

export const updateDoctorTask = async (
  data: DoctorTaskRequest,
): Promise<ApiResponse<DoctorTaskResponse>> =>
  api.put<unknown, ApiResponse<DoctorTaskResponse>, DoctorTaskRequest>(
    "DoctorTask",
    data,
  );

export const patchDoctorTask = async (
  data: DoctorTaskRequest,
): Promise<ApiResponse<DoctorTaskResponse>> =>
  api.patch<unknown, ApiResponse<DoctorTaskResponse>, DoctorTaskRequest>(
    "DoctorTask",
    data,
  );

export const deleteDoctorTask = async (
  id: number,
): Promise<ApiResponse<DoctorTaskResponse>> =>
