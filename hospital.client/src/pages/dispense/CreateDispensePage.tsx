      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="flex flex-col gap-3 rounded-lg border border-red-300 bg-red-50 p-6 text-center">
          ...
          <p className="text-red-700">
            ...
            <strong>{daysOld} días</strong> y ya no es válida para despacho. El
            paciente debe solicitar una nueva receta al médico tratante.
          </p>
          <p className="text-sm text-red-600">
            Las recetas son válidas por un máximo de 7 días desde su fecha de
            emisión.
          </p>
          <button
